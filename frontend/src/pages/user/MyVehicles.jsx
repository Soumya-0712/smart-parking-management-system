  ...
  useEffect(() => {
    async function fetchVehicles() {
      try {
        ...
        const message =
          error.response?.data?.message || "Unable to fetch your vehicles.";
      ...
      {showAddVehicle && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-2xl border border-gray-800 bg-[#0a0f1c] p-7 shadow-2xl">
            ...
            <form onSubmit={handleSubmitVehicle} className="mt-6 space-y-5">
              {/* Vehicle Number */}
              <div>
              ...
              {addVehicleError && (
                <div className="rounded-xl border border-red-500/20 bg-red-500/5 px-4 py-3">
                  <p className="text-sm text-red-400">{addVehicleError}</p>
                </div>
              )}
      ...
      {showEditVehicle && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-2xl border border-gray-800 bg-[#0a0f1c] p-7 shadow-2xl">
            ...
            <form onSubmit={handleUpdateVehicle} className="mt-6 space-y-5">
              {/* Vehicle Number */}
              <div>
                <label className="mb-2 block text-sm font-medium text-gray-300">
                  Vehicle Number
              ...
              {editVehicleError && (
                <div className="rounded-xl border border-red-500/20 bg-red-500/5 px-4 py-3">
                  <p className="text-sm text-red-400">{editVehicleError}</p>
                </div>
              )}
      ...
      {showDeleteVehicle && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-2xl border border-red-500/20 bg-[#0a0f1c] p-7 shadow-2xl">
            <h2 className="text-2xl font-bold text-white">Delete Vehicle?</h2>
