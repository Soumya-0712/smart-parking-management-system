    ...
    <div className="relative min-h-screen overflow-hidden bg-[#070B14] px-4 py-10 font-sans text-white sm:px-6 lg:px-8">
      ...
      <div className="relative mx-auto max-w-4xl space-y-8">
        ...
        <section className="rounded-2xl border border-gray-800/80 bg-[#0a0f1c] p-6 shadow-2xl">
          <h2 className="text-xl font-bold text-white">City Center Parking</h2>

          <p className="mt-2 text-cyan-400">Slot: A1</p>
        ...
        {/* Duration Selection */}
        <section className="rounded-2xl border border-gray-800/80 bg-[#0a0f1c] p-6 shadow-2xl">
          <h2 className="text-xl font-bold text-white">Parking Duration</h2>
                ...
                <button
                  ...
                  className={`rounded-xl border-2 px-5 py-5 font-semibold transition ${
                    isSelected
                      ...
                      : "border-gray-800 bg-[#070B14] text-gray-300 hover:border-cyan-500/50 hover:bg-white/2 hover:text-white"
                  }`}
                >
          ...
          <div className="mt-8 rounded-xl border border-gray-800/70 bg-[#070B14] p-5">
            <div className="flex items-center justify-between">
              ...
              <span className="font-medium text-gray-200">₹{ratePerHour}</span>
            </div>
