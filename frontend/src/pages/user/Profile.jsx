...
function Profile() {
  ...
  useEffect(() => {
    async function fetchCurrentUser() {
      try {
        ...
        setError(
          error.response?.data?.message || "Unable to fetch your profile.",
        );
      } finally {
        setLoading(false);
      }
  ...
  function handleSave() {
    ...
    console.log("Profile changes are currently local only:", profileData);
      ...
      <div className="relative min-h-screen overflow-hidden bg-[#070B14] px-4 py-10 font-sans text-white sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto flex min-h-[60vh] max-w-5xl items-center justify-center">
          <div className="w-full max-w-md rounded-2xl border border-red-500/20 bg-[#0a0f1c] p-10 text-center shadow-2xl">
            <p className="font-semibold text-red-400">Unable to load profile</p>
      ...
      <div className="relative mx-auto max-w-5xl space-y-8">
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="mt-1 text-gray-400">{profileData.email}</p>
            ...
            <div className="mt-6 space-y-5">
              ...
              <div className="rounded-xl border border-yellow-500/20 bg-yellow-500/5 px-4 py-3">
                <p className="text-sm text-yellow-400">
                  Profile editing is not connected to the server yet. Your
                  changes will not be saved after leaving this page.
                </p>
              </div>
        ...
        <section className="rounded-2xl border border-gray-800/80 bg-[#0a0f1c] p-6 shadow-2xl">
          ...
          <div className="mt-6 space-y-5">
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium text-gray-200">Email Verification</p>
        ...
        <section className="grid gap-4 md:grid-cols-2">
          ...
          >
            <h3 className="font-bold text-white">My Vehicles</h3>
