...
const createVehicle = async ({ userId, vehicleNumber, vehicleType }) => {
...
const updateVehicleById = async (
  ...
  if (vehicle.userId !== userId) {
    throw new ApiError(403, "You are not authorized to access this vehicle");
  }
  ...
  const updatedVehicle = await prisma.vehicle.update({
    ...
    data: {
      vehicleNumber: normalizedVehicleNumber ?? vehicle.vehicleNumber,
